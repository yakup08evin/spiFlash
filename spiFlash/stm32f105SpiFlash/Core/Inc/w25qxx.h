...
typedef struct{
	...
	uint32_t readDataByte;
	uint32_t readOffset;
	uint32_t LastDataSize;
	uint32_t bufferCountStoreforWrite;
	uint32_t sectorNumberforWrite;
	uint32_t sectorNumberforRead;
	...
	void W25qxx_Write(uint8_t *pBuffer, uint32_t NumByteToWrite);
